...
export default function EditBranchForm({ office }: { office: OfficeForm }) {
            ...
            <div className="relative mt-2 rounded-md">
              <div className="relative">
                <input
                  ...
                  defaultValue={state?.values?.name ?? office.office_name ?? ""}
            ...
            <div className="relative mt-2 rounded-md">
              <div className="relative">
                <input
                  ...
                  defaultValue={state?.values?.manager ?? office.manager ?? ""}
                  className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
                  // required
                />
                <CurrencyDollarIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
            ...
            <div className="relative mt-2 rounded-md">
              <div className="relative">
                <input
                  ...
                  defaultValue={state?.values?.contact ?? office.contact ?? ""}
                  className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
                  // required
                />
                <CurrencyDollarIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
            ...
            <div className="relative mt-2 rounded-md">
              <div className="relative">
                <input
                  ...
                  defaultValue={state?.values?.bin ?? office.bin ?? ""}
                  className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
                  // required
                />
                <CurrencyDollarIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <textarea
                ...
                defaultValue={state?.values?.address ?? office.address ?? ""}
                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
              />
